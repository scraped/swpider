...
class SwooleBeanstalk
{
    const PHEANSTALK_VERSION = '3.0.2';
    ...
    {
        $this->setConnection(new SwooleConnection($host, $port, $connectTimeout, $connectPersistent));
    }

    /**
     * {@inheritdoc}
     */
    public function setConnection(SwooleConnection $connection)
    {
    ...
    {
        $new_connection = new SwooleConnection(
